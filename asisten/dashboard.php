    ...
    <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:shadow-lg transition duration-300">
        <div class="flex items-center space-x-4">
            ...
            <div>
                ...
                <p class="text-2xl font-extrabold text-gray-800"><?php echo $count_total_modul; ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:shadow-lg transition duration-300">
        <div class="flex items-center space-x-4">
            ...
            <div>
                ...
                <p class="text-2xl font-extrabold text-gray-800"><?php echo $count_total_laporan; ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:shadow-lg transition duration-300">
        <div class="flex items-center space-x-4">
            ...
            <div>
                ...
                <p class="text-2xl font-extrabold text-gray-800"><?php echo $count_belum_dinilai; ?></p>
            </div>
        </div>
    </div>
</div>

<div class="bg-white p-6 rounded-xl shadow-md mt-10 border border-gray-100">
            ...
            <?php while ($aktivitas = mysqli_fetch_assoc($result_aktivitas)): ?>
                <div class="flex items-center py-4">
                    <div class="w-10 h-10 rounded-full bg-red-100 flex items-center justify-center mr-4">
                        <span class="font-bold text-sky-700"><?php echo strtoupper(substr($aktivitas['nama_mahasiswa'], 0, 2)); ?></span>
                    </div>
                    <div>
                        <p class="text-gray-800">
                            <strong><?php echo htmlspecialchars($aktivitas['nama_mahasiswa']); ?></strong> mengumpulkan laporan untuk 

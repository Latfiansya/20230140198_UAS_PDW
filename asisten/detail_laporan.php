...
<div class="max-w-4xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <h3 class="text-xl font-bold text-emerald-700 border-b pb-3 mb-4">Detail Laporan</h3>
            ...
            <div class="mt-6">
                <a href="../uploads/laporan/<?php echo htmlspecialchars($laporan['file_laporan']); ?>" target="_blank"
                    class="w-full inline-flex justify-center items-center px-4 py-2 border border-transparent
                            text-sm font-medium rounded-md text-white bg-emerald-600 hover:bg-emerald-700 transition">
                    <svg class="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
                                d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5
                                    m0 0L7.5 12m4.5 4.5V3"/>
                    </svg>
                    Unduh File Laporan
                </a>
            </div>
        ...
        <!-- Form Penilaian -->
        <div class="bg-white p-6 rounded-lg shadow-md">
            <h3 class="text-xl font-bold text-emerald-700 border-b pb-3 mb-4">Form Penilaian</h3>
            <form method="POST" class="space-y-5">
                <div>
                    ...
                    <input type="number" step="0.01" name="nilai" id="nilai"
                            value="<?php echo htmlspecialchars($laporan['nilai'] ?? ''); ?>"
                            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm
                                    focus:ring-emerald-500 focus:border-emerald-500 focus:outline-none sm:text-sm"
                            required>
                </div>
                ...
                <div>
                    ...
                    <textarea name="feedback" id="feedback" rows="8"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm
                                        focus:ring-emerald-500 focus:border-emerald-500 focus:outline-none sm:text-sm"><?php echo htmlspecialchars($laporan['feedback'] ?? ''); ?></textarea>
                </div>
